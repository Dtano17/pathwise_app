...
async function getCredentials() {
  // First try environment variables (for deployed apps without Replit connectors)
  const envSecretKey = process.env.STRIPE_SECRET_KEY || process.env.STRIPE_API_KEY;
