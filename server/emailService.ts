        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 20px; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.08); overflow: hidden;">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #8b5cf6 0%, #6366f1 50%, #7c3aed 100%); padding: 50px 40px; text-align: center;">
              <h1 style="margin: 0 0 12px; color: #ffffff; font-size: 36px; font-weight: 700; letter-spacing: -0.5px;">Welcome to JournalMate</h1>
              <p style="margin: 0; color: #e9d5ff; font-size: 18px; font-weight: 500;">your social planning &amp; adaptive journal</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 35px 40px 20px;">
              <h3 style="margin: 0 0 28px; color: #8b5cf6; font-size: 22px; font-weight: 700; text-align: center;">✨ What Makes JournalMate Different</h3>
              
              <div style="margin-bottom: 24px;">
                <h4 style="margin: 0 0 8px; color: #111827; font-size: 17px; font-weight: 600;">🔗 Shared Activities &amp; Group Sync</h4>
              ...
              <div style="margin-bottom: 24px;">
                <h4 style="margin: 0 0 8px; color: #111827; font-size: 17px; font-weight: 600;">🎯 Customizable &amp; Adaptive Planning</h4>
                <p style="margin: 0; color: #4b5563; font-size: 15px; line-height: 1.6;">
              ...
              <div style="margin-bottom: 24px;">
                <h4 style="margin: 0 0 8px; color: #111827; font-size: 17px; font-weight: 600;">📸 Auto-Journaling with Feedback Loops</h4>
                <p style="margin: 0; color: #4b5563; font-size: 15px; line-height: 1.6;">
              ...
              <div style="margin-bottom: 24px;">
                <h4 style="margin: 0 0 8px; color: #111827; font-size: 17px; font-weight: 600;">🧠 Behavioral Intelligence Engine</h4>
                <p style="margin: 0; color: #4b5563; font-size: 15px; line-height: 1.6;">
              ...
              <div style="margin-bottom: 24px;">
                <h4 style="margin: 0 0 8px; color: #111827; font-size: 17px; font-weight: 600;">🎨 Visual Previews &amp; Emotional Tagging</h4>
                <p style="margin: 0; color: #4b5563; font-size: 15px; line-height: 1.6;">
