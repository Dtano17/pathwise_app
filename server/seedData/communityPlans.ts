...
export const demoCommunityPlans = [
  ...
  },
  {
    activity: {
      ...
      backdrop: "person_coding_on_lap_ba381062.jpg",
  ...
  },
  {
    activity: {
      ...
      backdrop: "home_renovation_kitc_0ceb0522.jpg",
  ...
  },
  {
    activity: {
      ...
      backdrop: "spanish_language_lea_2d2edb39.jpg",
    ...
    tasks: [
      { title: "Complete Duolingo Spanish course (30 min/day)", description: "Build foundation vocabulary and grammar", category: "personal", priority: "high" as const, timeEstimate: "30 min/day" },
      { title: "Practice conversation with italki tutor (3x/week)", description: "One-on-one sessions with native speakers", category: "personal", priority: "high" as const, timeEstimate: "1 hour" },
      { title: "Watch Spanish shows with subtitles", description: "Netflix series to improve listening", category: "personal", priority: "high" as const, timeEstimate: "30 min/day" },
      { title: "Join local Spanish conversation meetup", description: "Practice speaking with learners", category: "personal", priority: "medium" as const, timeEstimate: "2 hours/week" },
      { title: "Learn 20 new words daily with flashcards", description: "Use Anki for spaced repetition", category: "personal", priority: "medium" as const, timeEstimate: "15 min/day" },
    ]
  },
  {
    activity: {
