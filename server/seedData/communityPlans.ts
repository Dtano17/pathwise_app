...
export const demoCommunityPlans = [
  ...
  },
  {
    activity: {
      ...
      backdrop: "@assets/stock_images/nfl_football_game_da_754e78a5.jpg",
      ...
      budget: 180000,
      budgetBreakdown: [
        { category: "Game tickets", amount: 95000, notes: "2 tickets upper deck section" },
        { category: "Tailgate supplies", amount: 35000, notes: "Food, drinks, grill rentals, team gear" },
        { category: "Rideshare home", amount: 25000, notes: "Uber/Lyft for safe transportation" },
        { category: "Stadium food & merch", amount: 25000, notes: "Concessions and souvenirs" }
      ],
      budgetBuffer: 18000,
    },
    tasks: [
  ...
  },
  {
    activity: {
      ...
      backdrop: "@assets/stock_images/austin_texas_skyline_15b9588d.jpg",
      ...
      budget: 75000,
      budgetBreakdown: [
        { category: "Brunch", amount: 30000, notes: "Bottomless mimosas and entrees for 2" },
        { category: "Shopping & treats", amount: 20000, notes: "SoCo boutiques, ice cream, coffee" },
        { category: "Live music cover", amount: 15000, notes: "Entry to local venue" },
        { category: "Dinner & drinks", amount: 10000, notes: "Food truck and sunset cocktails" }
      ],
      budgetBuffer: 7500,
    },
    tasks: [
  ...
  },
  {
    activity: {
      ...
      description: "Epic 3-day Austin City Limits music festival with camping, top artists, and responsible celebration",
      category: "travel" as const,
      planSummary: "Complete ACL Festival experience with premium camping, artist lineup planning, festival essentials, and safe transportation strategy",
      isPublic: true,
      shareTitle: "Austin ACL Festival Weekend",
      backdrop: "@assets/stock_images/live_music_festival__78eabd78.jpg",
      ...
      budget: 850000,
      budgetBreakdown: [
        { category: "3-day festival pass", amount: 350000, notes: "General admission wristband" },
        { category: "Accommodation", amount: 300000, notes: "Airbnb near Zilker Park for 3 nights" },
        { category: "Food & drinks", amount: 120000, notes: "Festival food vendors and hydration" },
        { category: "Transportation", amount: 50000, notes: "Rideshares, scooter rentals, bike share" },
        { category: "Merch & extras", amount: 30000, notes: "Artist merchandise and festival gear" }
      ],
      budgetBuffer: 85000,
    },
    tasks: [
      ...
      { title: "Book Airbnb within walking distance of Zilker", description: "South Austin or Travis Heights neighborhood, 2-3 bedrooms for group", category: "travel", priority: "high" as const, timeEstimate: "2 hours" },
  ...
  },
  {
    activity: {
      ...
      backdrop: "@assets/stock_images/formula_1_racing_car_5c904cbb.jpg",
  ...
  },
  {
    activity: {
      ...
      description: "Navigate South by Southwest with badge strategy, must-see showcases, networking events, and interactive experiences",
      category: "travel" as const,
      planSummary: "Complete SXSW survival guide covering badge types, showcase priorities, tech activations, film screenings, and responsible party-hopping",
      isPublic: true,
      shareTitle: "Austin SXSW Music & Tech Festival",
      backdrop: "@assets/stock_images/sxsw_music_technolog_b071c2cb.jpg",
      ...
      budget: 700000,
      budgetBreakdown: [
        { category: "SXSW badge", amount: 350000, notes: "Music badge for venue access" },
        { category: "Accommodation", amount: 200000, notes: "Airbnb east of I-35, 5 nights" },
        { category: "Food & drinks", amount: 80000, notes: "Food trucks, sponsored parties, late-night tacos" },
        { category: "Transportation", amount: 40000, notes: "Bike rental, scooters, occasional rideshares" },
        { category: "Swag & merch", amount: 30000, notes: "Artist merchandise, limited edition releases" }
      ],
      budgetBuffer: 70000,
    },
    tasks: [
      { title: "Purchase SXSW badge during early bird pricing", description: "Music badge offers best value for showcase access, register before December", category: "travel", priority: "high" as const, timeEstimate: "1 hour" },
      { title: "Book accommodations east of downtown", description: "East 6th, East Cesar Chavez for walkable access to venues", category: "travel", priority: "high" as const, timeEstimate: "2 hours" },
