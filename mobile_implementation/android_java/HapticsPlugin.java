...
public class HapticsPlugin extends Plugin {
    ...
    /**
     * Selection alias (parity with iOS)
     */
    @PluginMethod
    ...
    /**
     * Store haptic preferences (parity with iOS)
     */
    @PluginMethod
    public void setPreferences(PluginCall call) {
        boolean enableHaptics = call.getBoolean("enableHaptics", true);
        boolean enableLaunchHaptic = call.getBoolean("enableLaunchHaptic", true);
        boolean enableCompletionHaptic = call.getBoolean("enableCompletionHaptic", true);

        getContext().getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE)
            .edit()
            .putBoolean("enableHaptics", enableHaptics)
            .putBoolean("enableLaunchHaptic", enableLaunchHaptic)
            .putBoolean("enableCompletionHaptic", enableCompletionHaptic)
            .apply();
    ...
    /**
     * Read haptic preferences (parity with iOS)
     */
    @PluginMethod
    public void getPreferences(PluginCall call) {
        ...
        result.put("enableHaptics", prefs.getBoolean("enableHaptics", true));
        result.put("enableLaunchHaptic", prefs.getBoolean("enableLaunchHaptic", true));
        result.put("enableCompletionHaptic", prefs.getBoolean("enableCompletionHaptic", true));
        call.resolve(result);
    }
}
