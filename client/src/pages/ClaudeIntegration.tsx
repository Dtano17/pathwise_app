      ...
      <section className="container mx-auto px-4 py-16 bg-white rounded-3xl my-12 shadow-xl">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold mb-2">1. Plan with Claude AI</h3>
            <p className="text-gray-600">
              Have a conversation with Claude about your goals. Get detailed, thoughtful planning assistance.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold mb-2">2. Copy to JournalMate</h3>
            <p className="text-gray-600">
              Copy your Claude conversation and paste it into JournalMate. Our AI parses it instantly.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold mb-2">3. Track & Complete</h3>
            <p className="text-gray-600">
              Get organized tasks, smart reminders, and automatic journaling as you progress.
            </p>
          </div>
        </div>
      </section>
