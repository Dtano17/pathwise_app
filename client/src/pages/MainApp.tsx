      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsList className="hidden sm:grid w-full grid-cols-6 mb-4 sm:mb-8 bg-muted/30 p-1 h-12">
      ...
      <Dialog open={showContacts} onOpenChange={onShowContacts}>
        <DialogContent className="max-w-[95vw] sm:max-w-6xl h-[90vh] flex flex-col" data-testid="modal-contacts">
          <DialogHeader backLabel="Back to Home">
            ...
            <DialogDescription>
              Manage your contacts, create groups, and share your goals with friends and family
            </DialogDescription>
          </DialogHeader>
