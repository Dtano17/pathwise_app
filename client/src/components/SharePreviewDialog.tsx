  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-3xl max-h-[85vh] w-[95vw] md:w-[85vw] lg:w-[70vw] p-4 sm:p-6 mt-safe mb-safe flex flex-col overflow-hidden">
          ...
          <Tabs
            ...
            className="w-full mt-4 flex-1 flex flex-col min-h-0 overflow-hidden"
          >
            <TabsList className="grid w-full grid-cols-3 h-auto p-1 bg-muted/50 rounded-lg flex-shrink-0">
              <TabsTrigger
                value="quick-share"
