    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-sidebar text-sidebar-foreground w-[var(--sidebar-width)] p-0 [&>button]:hidden safe-all"
          style={
            {
        ...
        >
          ...
          <div className="flex h-full w-full flex-col overflow-y-auto scrollbar-thin">{children}</div>
        </SheetContent>
      </Sheet>
    )
  }
